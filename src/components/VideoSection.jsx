    ...
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-12">
          <span className="text-sm font-bold text-[#ef7822] uppercase tracking-wider mb-2 block">Virtual Tour</span>
          ...
          <p className="text-[#606060] text-lg leading-relaxed">
            ...
            environment we've created for our students and discover what makes our school special.
          </p>
        </div>
            ...
            {!isPlaying ? (
              <>
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white">
                  <h3 className="text-2xl font-bold mb-2">Discover SEERH School</h3>
                  <p className="text-white/90">Experience our campus, meet our teachers, and see our students in action</p>
                </div>
              </>
            ) : (
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#f8f9fa] p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
              <div className="flex items-center mb-4">
                <div className="bg-[#0d4c83]/10 w-12 h-12 rounded-full flex items-center justify-center mr-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#0d4c83]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <h3 className="text-lg font-semibold text-[#0d4c83]">Modern Facilities</h3>
              </div>
              <p className="text-[#606060]">State-of-the-art classrooms, labs, and recreational spaces designed for optimal learning.</p>
            </div>
            ...
            <div className="bg-[#f8f9fa] p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-[#0d4c83]">Expert Faculty</h3>
              </div>
              <p className="text-[#606060]">Dedicated teachers who are passionate about education and student development.</p>
            </div>
            ...
            <div className="bg-[#f8f9fa] p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-[#0d4c83]">Happy Students</h3>
              </div>
              <p className="text-[#606060]">A nurturing environment where students thrive academically, socially, and emotionally.</p>
            </div>
          </div>
        </div>
      </div>
